...
> [!WARNING]
> `axe-storybook-testing` will be archived on **January 5, 2026**. The recommended replacement is to use the built-in storybook accessibility testing
> tools. More information on migrating away from `axe-storybook-testing` can be found [in the wiki](https://github.com/chanzuckerberg/axe-storybook-testing/wiki/Migrating-away-from-axe%E2%80%90storybook%E2%80%90testing).
